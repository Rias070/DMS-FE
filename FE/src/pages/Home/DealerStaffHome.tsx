...
import AccessibleFeatures from '../../components/common/AccessibleFeatures';
import RoleGuidance from '../../components/common/RoleGuidance';

const DealerStaffHome: React.FC = () => {
  const { user } = useAuth();
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <div className="mt-2 px-3 py-1 bg-indigo-100 text-indigo-800 rounded-full text-sm inline-block">
          Role: Dealer Staff
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">My Assignments</p>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <div className="flex items-center">
              ...
              <div>
                <p className="font-medium text-gray-900 dark:text-white">Customer follow-up call</p>
                <p className="text-sm text-gray-600 dark:text-gray-400">Due: Today at 2:00 PM</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <div className="flex items-center">
              ...
              <div>
                <p className="font-medium text-gray-900 dark:text-white">Update customer database</p>
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <div className="flex items-center">
              ...
              <div>
                <p className="font-medium text-gray-900 dark:text-white">Prepare sales report</p>
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <button 
            onClick={() => {
              console.log('Navigating to /ecommerce/customers');
          ...
          >
            <div className="text-center">
              ...
              <p className="text-sm font-medium text-gray-900 dark:text-white">Test Drive</p>
            </div>
          </button>
...
export default DealerStaffHome;
